...
const Hero = () => {
    ...
    const scrollToSection=(id) =>{
      ...
      getId && getId.scrollIntoView({behavior:'smooth', block:'start'})
    }
      ...
      <section id="hero" className="hero section accent-background">
        <div className="container position-relative" data-aos="fade-up" data-aos-delay={100}>
          <div className="row gy-5 justify-content-between">
            ...
            <h2 className="text-orange"><span> Más de 36 años de experiencia en el mercado, </span><span className="text-blue">enfocada en el sector de protección, ahorro e inversiones, desarrollando empresarios en el sector asegurador.</span></h2>
